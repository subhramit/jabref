...
public class CSLCitationOOAdapter {
    ...
    public void insertInTextCitation(XTextCursor cursor, CitationStyle selectedStyle, List<BibEntry> entries, BibDatabaseContext bibDatabaseContext, BibEntryTypesManager bibEntryTypesManager)
        ...
        while (iterator.hasNext()) {
            ...
            String finalText = generateInTextCitation(currentEntry, selectedStyle, bibDatabaseContext, bibEntryTypesManager);
            if (iterator.hasNext()) {
                finalText += ",";
            }
    ...
    private static String changeToInText(String formattedCitation) {
    ...
    private static String generateAlphanumericCitation(List<BibEntry> entries, BibDatabaseContext bibDatabaseContext) {
    ...
    private static boolean isAlphanumericStyle(CitationStyle style) {
